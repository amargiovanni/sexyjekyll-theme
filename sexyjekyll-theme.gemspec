...
Gem::Specification.new do |spec|
  ...
  spec.description = 'SexyJekyll is a professional Jekyll theme featuring advanced search, ' \
                     'reading progress, related posts, structured data, responsive design, ' \
                     'comprehensive accessibility support, and AI-friendly llms.txt generation.'
  ...
  spec.files = `git ls-files -z`.split("\x0").select do |f|
    f.match(/^(assets|css|js|_layouts|_includes|_plugins|_sass|LICENSE|README|CHANGELOG|\.md$)/i)
  end
  ...
  spec.add_dependency 'liquid_reading_time', '~> 1.1'
